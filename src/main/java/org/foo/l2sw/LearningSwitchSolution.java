...
@Service
public class LearningSwitchSolution implements LearningSwitchService {
    ...
    protected void activate() {
        log.info("Started");
        appId = coreService.registerApplication("org.foo.l2sw"); //equal to the name shown in pom.xml file
	...
	public String getHello() {
		return "Hello from LearningSwitchService";
	}
}
